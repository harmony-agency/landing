...
var WaveSurfer = {
  ...
  init: function (a) {
    if (
      ((this.params = WaveSurfer.util.extend({}, this.defaultParams, a)),
      (this.container =
  ...
  createBackend: function () {
    ...
    this.backend && this.backend.destroy(),
      ...
      'WebAudio' != this.params.backend ||
        WaveSurfer.WebAudio.supportsWebAudio() ||
        (this.params.backend = 'MediaElement'),
  ...
  seekTo: function (a) {
    ...
    b && (this.params.scrollParent = !1),
      ...
      b || (this.backend.pause(), this.backend.play()),
  ...
  loadBuffer: function (a) {
    return (
      this.empty(), this.getArrayBuffer(a, this.loadArrayBuffer.bind(this))
    );
  },
  ...
  getArrayBuffer: function (a, b) {
    var c = this,
      d = WaveSurfer.util.ajax({ url: a, responseType: 'arraybuffer' });
    return (
      this.tmpEvents.push(
  ...
  exportPCM: function (a, b, c) {
    ...
    return (
      c ||
        window.open(
          'data:application/json;charset=utf-8,' + encodeURIComponent(f)
        ),
      f
    );
  },
...
(WaveSurfer.create = function (a) {
      ...
      return (
        ...
        c.addEventListener('load', function (a) {
          d || b.fireEvent('progress', a),
            b.fireEvent('load', a),
            200 == c.status || 206 == c.status
              ? b.fireEvent('success', c.response, a)
              : b.fireEvent('error', a);
        }),
  ...
  (WaveSurfer.Observer = {
    on: function (a, b) {
      ...
      return (
        c || (c = this.handlers[a] = []),
        c.push(b),
        { name: a, callback: b, un: this.un.bind(this, a, b) }
      );
    },
    un: function (a, b) {
      if (this.handlers) {
  ...
  (WaveSurfer.WebAudio = {
    ...
    getAudioContext: function () {
      return (
        WaveSurfer.WebAudio.audioContext ||
          (WaveSurfer.WebAudio.audioContext = new (window.AudioContext ||
        ...
        WaveSurfer.WebAudio.offlineAudioContext ||
          (WaveSurfer.WebAudio.offlineAudioContext =
            new (window.OfflineAudioContext ||
              window.webkitOfflineAudioContext)(1, 2, a)),
        WaveSurfer.WebAudio.offlineAudioContext
      );
    },
    init: function (a) {
    ...
    setState: function (a) {
      this.state !== this.states[a] &&
        ((this.state = this.states[a]), this.state.init.call(this));
    },
    setFilter: function () {
    ...
    addOnAudioProcess: function () {
      ...
      this.scriptNode.onaudioprocess = function () {
        ...
        b >= a.getDuration()
          ...
          : b >= a.scheduledPause
          ? (a.setState(a.PAUSED_STATE), a.fireEvent('pause'))
    ...
    getPeaks: function (a) {
      for (
        var b = this.buffer.length / a,
          c = ~~(b / 10) || 1,
          d = this.buffer.numberOfChannels,
          e = [],
          f = [],
          g = 0;
        d > g;
        ...
        for (
          var h = (e[g] = []), i = this.buffer.getChannelData(g), j = 0;
          a > j;
          j++
        ) {
          for (
            var k = ~~(j * b), l = ~~(k + b), m = i[0], n = i[0], o = k;
            l > o;
            o += c
          ) {
            var p = i[o];
    ...
    seekTo: function (a, b) {
      return (
        (this.scheduledPause = null),
        null == a &&
          ((a = this.getCurrentTime()), a >= this.getDuration() && (a = 0)),
    ...
    setPlaybackRate: function (a) {
      (a = a || 1),
        this.isPaused()
          ? (this.playbackRate = a)
          : (this.pause(), (this.playbackRate = a), this.play());
    },
  }),
  ...
  WaveSurfer.util.extend(WaveSurfer.MediaElement, {
    ...
    clearPlayEnd: function () {
      this.onPlayEnd &&
        (this.un('audioprocess', this.onPlayEnd), (this.onPlayEnd = null));
    },
    getPeaks: function (a) {
      return this.buffer
        ? WaveSurfer.WebAudio.getPeaks.call(this, a)
        : this.peaks || [];
    },
    getVolume: function () {
  ...
  (WaveSurfer.Drawer = {
    ...
    handleEvent: function (a) {
      ...
      return (
        (a.clientX - b.left + this.wrapper.scrollLeft) /
    ...
    destroy: function () {
      this.unAll(),
        this.wrapper &&
          (this.container.removeChild(this.wrapper), (this.wrapper = null));
    },
    ...
    drawBars: function (a, b) {
      if (a[0] instanceof Array) {
        ...
        if (this.params.splitChannels)
          return (
            this.setHeight(
              c.length * this.params.height * this.params.pixelRatio
            ),
    ...
    var a = function () {
      ...
      Array.prototype.forEach.call(a, function (a) {
        var b = WaveSurfer.util.extend(
          { container: a, backend: 'MediaElement', mediaControls: !0 },
          a.dataset
        );
